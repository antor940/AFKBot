...
logToLog('<src/modules/Eat.js> Passed');

async function autoEat()
{
    logToLog('<src/modules/Eat.js/Function autoEat> Passed');
...
async function enablePlugin()
{
    ...
    bot.autoEat.enable();
    logToLog('<src/modules/Eat.js/Function enablePlugin> Passed');
...
async function disablePlugin()
{
    ...
    bot.autoEat.disable();
    logToLog('<src/modules/Eat.js/Function disablePlugin> Passed');
